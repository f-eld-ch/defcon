...
export default class extends React.Component {
  ...
  renderTitle() {
      ...
      if (message) {
          return (<h2>Journal-Eintrag bearbeiten</h2> );
      }
      return (<h2>Journal-Eintrag erstellen</h2> );
  }
  ...
  render() {
      ...
      return(
          <div className="hidden-print">
              <Error error={error} clearErrors={clearErrors} />
              {this.renderTitle()}
  ...
  renderButtons() {
    ...
    if (!message) {
      return (
          <div className="form-group">
              <div className="col-xs-offset-1 col-xs-11">
                  <button type="submit" className="btn btn-primary" onClick={this.saveMessage.bind(this)}><i className="fa fa-floppy-o"> </i>&nbsp; Speichern</button>
              </div>
          </div>
      );
    } else {
      return (
          <div className="form-group">
              <div className="col-xs-offset-1 col-xs-11">
                  <button type="submit" className="btn btn-primary btn-block" onClick={this.saveMessage.bind(this)}><i className="fa fa-floppy-o"> </i>&nbsp; Speichern</button>
                  <button type="close-incident" className="btn btn-danger btn-block" onClick={this.deleteMessage.bind(this)} ><i className="fa fa-trash-o"></i>&nbsp; Löschen</button>
              </div>
          </div>
      );
    }
